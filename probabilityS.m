...
ne = 1000;    % number of Monte-Carlo integrations
S_array=[];STD=[];
Fraction=[];
for Ss=0.04:0.05:0.2,% trial is the initial value of v_0
    s=Ss;
...
figure(4);
plot(S_array, Fraction, '.-b', 'markersize', 10)
xlabel('T (150<p<250)'); 
ylabel('H(T)'); 
